...
### MMB predicting anxious/aggressive cognition by threat condition

```{r}
plotLine("mmb_pressured_score", "aggressiveWordCompletionScore", condition = "threatCondition", df = df)
```

```{r}
plotLine("mmb_autonomous_score", "anxiousWordCompletionScore", condition = "threatCondition", df = df)
```
