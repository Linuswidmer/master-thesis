...
```{r}
ummary_table(glm_anx$model, "Anxious Cognition GLM (Full Sample)") %>%
...
```{r}
ummary_table(glm_agg_mod$model, "Aggressive Cognition Moderation GLM") %>%
...
```{r}
ummary_table(glm_anx_mod$model, "Anxious Cognition Moderation GLM") %>%
