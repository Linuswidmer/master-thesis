...
- Visualization & Descriptives
- Prerequisites for inference statistics (homogeneity, normal distribution)
- Inference Statistics (Generalized Linear Model)
...
Transforming values to ensure independence between value and variance
```{r}
...
- Transformed aggressive cognition scores show a zero inflation, thus we cannot assume a normality 
