...
# Factor Structure Aggressive Cognition

## Aggressive Cognition

Assessing factor structure for aggressive cognition items. These should only show a
response in the threat condition
```{r}
df_threat <- df %>%
