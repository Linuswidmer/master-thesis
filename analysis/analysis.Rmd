...
```{r message=FALSE, warning=FALSE, include=FALSE}
source(here("analysis", "word-catalog.R"))
source(here("analysis", "items-and-labels.R"))
source(here("analysis", "data-preprocessing.R"))
source(here("analysis", "visualization.R"))
source(here("analysis", "utils.R"))
source(here("analysis", "simulation.R"))
source(here("analysis", "inference-statistics.R"))
source(here("analysis", "factor-analysis.R"))
```
