...
### 3.2 Self evaluation of Gender Knowledge
...
# Test Quality Criteria: Anxious Cognition
*Objectives:*
...
```{r}
bad_items <- c("WFCTanx2", "WFCTanx8", "WFCTanx10")
WFCT_anx_clean <- df[, setdiff(WFCT_anxiety_items, bad_items)]
``` 
