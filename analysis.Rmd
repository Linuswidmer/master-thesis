...
## Confirmatory Factor analysis: Motivation for Masculine Behaviour
...
```{r}
t.test(
  aggressiveWordCompletionScoreTransformed ~ threatCondition,
  data = df,
  alternative = "greater"
)
```
...
```{r}
t.test(
  anxiousWordCompletionScoreTransformed ~ threatCondition,
  data = df,
  alternative = "greater"
)
```
