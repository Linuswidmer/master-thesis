...
#apa-figure(
  ...
  caption: [Exploratory Factor Analaysis Loadings for Motivation for Masculine Behavior Scale],
  note: [
...
Participants in the threat condition reported lower scores (#reportMeanAndSD(mean: 5.71, sd: 1.43)) than those in the no-threat condition (#reportMeanAndSD(mean: 6.79, sd: 1.38)). 
...
Nine participants correctly identified the experimental manipulation of the feedback and were flagged for potential exclusion during the data cleaning process.