...
== Manipulation Check
To ensure the experimental manipulation was successful, participants were asked to recall the nature of the feedback they received on the Gender Knowledge Test. Responses were recorded on a scale ranging from 1 (_typically feminine_) to 10 (_typically masculine_).
...
n addition to feedback recall, participants provided a self-evaluation of their own gender knowledge using the same 10-point scale (1 = typically feminine, 10 = typically masculine). This measure served to assess the credibility of the experimental manipulation, determining whether the feedback actually shifted participants' internal perceptions of their gender-related expertise.
